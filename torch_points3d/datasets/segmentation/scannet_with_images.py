...
class Scannet(InMemoryDataset):
    ...
    def download_scans(self):
        ...
        release_scans = ["scene0000_00", "scene0000_01", "scene0000_02"]
    ...
    def process_func(
        ...
        print("{}/{}| scan_name: {}, data: {}".format(id_scan, total, scan_name, data))
    ...
    def process(self):
        ...
        for i, (scan_names, split) in enumerate(zip(self.scan_names, self.SPLITS)):
            if not os.path.exists(self.processed_paths[i]):
                ...
                print("SAVING TO {}".format(self.processed_paths[i]))
...
class ScannetDatasetWithImages(BaseDataset):
...
if __name__ == '__main__':
    ...
    dataset = ScannetDatasetWithImages(dataset_options.data)
    print(dataset)
