...
class MMData(object):
    ...
    in ForwardStar objects.

    Provides sanity checks to ensure the validty of the data, along with 
    ...
    def debug(self):
        ...
        assert isinstance(self.mappings, ForwardStar)
...
class MMBatch(MMData):
    ...
    def to_mm_data_list(self):
        ...
        mappings_list = self.mappings.to_forward_star_list()
